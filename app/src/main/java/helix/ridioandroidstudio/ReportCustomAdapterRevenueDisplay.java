/** Ridio v1.0.1
 * 	Purpose	   : Report Custom Adapter for Revenue
 *  Created by : Abish 
 *  Created Dt : old file
...
public class ReportCustomAdapterRevenueDisplay extends BaseAdapter{ 
	...
	public ReportCustomAdapterRevenueDisplay(ReportRevenueBasedOnBikes reportPastBooking, List<String> id, List<String> _name,
...
//	public ReportCustomAdapterRevenueDisplay(ReportPastBooking reportPastBooking, List<String> id, List<String> _name,
//			List<String> _number, List<String> eml, List<String> bike_number, List<String> dy_rt) {
//		_id=id;
//		c_name1=_name;
//		m_no1=_number;
...
//	            getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//	}
	public ReportCustomAdapterRevenueDisplay(ReportFutureBooking reportFutureBooking, List<String> bike_reg,
			List<String> bike_n, List<String> total_dy, List<String> booked_dy, List<String> days_percent,
			List<String> total_amt) {
		
	}

	public ReportCustomAdapterRevenueDisplay(ReportFutureBooking reportFutureBooking, List<String> day
			, List<String> total_dy,List<String> booked_dy, List<String> days_percent, List<String> total_amt) {
		c_name1=day;
		m_no1=total_dy;
		email1=booked_dy;		
		b_no1=days_percent;
		day_rate1=total_amt;
		context=reportFutureBooking;
	    inflater = ( LayoutInflater )context.
	            getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	}
